...
public class Main {
    public static void main(String[] args) {
        ...
        NumberFormat nf = NumberFormat.getNumberInstance(locale); //FORMATOWANIE DO 6 ZER PO PRZECINKU
        nf.setMinimumFractionDigits(6); //Ustawia minimum 6 zer
        nf.setMaximumFractionDigits(6); // Ustawia max 6 zer
        if (a > b && b > c) {
